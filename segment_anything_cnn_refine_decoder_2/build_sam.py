...
from .modeling import ImageEncoderViT, MaskDecoder,MaskDecoder2, PromptEncoder, Sam, TwoWayTransformer,TwoWayTransformer2
...
def _build_sam(
    ...
    sam = Sam(
        ...
        mask_decoder2=MaskDecoder2(
            num_multimask_outputs=3,
            transformer=TwoWayTransformer2(
                # depth=2,
                depth=5,
                embedding_dim=prompt_embed_dim,
                mlp_dim=2048,
...
def load_from(sam, state_dicts, image_size, vit_patch_size):
    ...
    # return sam_dict
    sam_dict = sam.state_dict()
    dict_trained = {k: v for k, v in state_dicts.items() if k in sam_dict}
